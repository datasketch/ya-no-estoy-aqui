<template>
  <div class="step px-4">
    ...
    <div style="margin-top: -100vh">
      ...
      >
        <h1 class="text-8xl text-purple font-playfair leading-none text-center font-extrabold">
      ...
      <div class="min-h-screen flex flex-col justify-center pb-12">
        ...
        />
        <div
          class="w-1/2 border-t-2 border-platinum mx-auto my-16 border-opacity-25"
        ></div>
        <div class="max-w-xl mx-auto font-charter text-platinum space-y-6 text-lg md:text-xl">
          <p>
          ...
          <img src="media/victimas-anio.png" alt="">
          <p>
          ...
          <p>
            Sobre ese cementerio de mujeres hoy sembramos flores. Este espacio web llamado <strong class="font-playfair"><span class="italic line-through">Ya no</span> estoy aquí</strong>  irá floreciendo con las historias que nos vayan contando los familiares. Con sus anécdotas, este propósito llegará a ser, muy pronto, un espacio de memoria y reivindicación.
          </p>
          <p>
            Mientras salimos del silencio, te invitamos a leer y a compartir en redes los <span class="italic">in memoriam</span> de mujeres que fueron valientes, amorosas, sonrientes.  Y si quieres contactarnos para reconstruir la historia de tu familiar y amiga, escríbenos al correo electrónico: <a href="mailto:yanoestoyaqui.cuestionpublica@gmail.com" class="text-sizzling-red break-all">yanoestoyaqui.cuestionpublica@gmail.com</a>. Esta labor de búsqueda estará vigente hasta hacer de ellas las siemprevivas.
          </p>
          <p class="text-center">
            <nuxt-link to="/metodologia" class="bg-sizzling-red px-3 py-2 inline-block rounded leading-none font-lato text-lg">Metodología</nuxt-link>
          </p>
        </div>
      </div>
    </div>
